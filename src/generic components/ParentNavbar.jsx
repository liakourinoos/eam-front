...
function ParentNavbar({page=1}){
    ...
    return(
        <div className={`w-full h-12 text-xl border-b-2  border-black font-medium items-center px-auto bg-pallete-50 flex justify-evenly`}>
            ...
            <Link to='/parentapplications'  onClick={()=>setSelectedPage(2)} className={`cursor-pointer ${selectedPage==2?"text-pallete-600 underline font-semibold" : 'text-black'}`}>Αιτήσεις</Link>

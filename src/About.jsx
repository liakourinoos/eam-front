    ...
    return (
      <div className='w-full min-h-screen flex flex-col justify-between bg-gray-50'>
        ...
        <div className="w-full  flex-grow relative ">
          <p className='ml-32 text-4xl font-bold  text-black mt-10 mb-2'>Εγχειρίδιο Χρήσης</p>
          <div className='w-1/3 border border-gray-300 shadow-md rounded-lg ml-32 py-4 pl-5 flex flex-col gap-4 text-lg font-medium bg-gray-100'>
            <p className='underline text-2xl'>Περιεχόμενα</p>
            <a href="#section1" className="hover:text-pallete-500">1. Εισαγωγή</a>
            <a href="#section2" className="hover:text-pallete-500">2. Δημιουργία Λογαριασμού/ Είσοδος στην υπηρεσία</a>              <a href="#section3" className="hover:text-pallete-500">3. Προφίλ Γονέα</a>
            <a href="#section4" className="hover:text-pallete-500">4. Προφίλ Επαγγελματία</a>
            <a href="#section5" className="hover:text-pallete-500">5. Αλλαγή Στοιχείων Λογαριασμού</a>
            <a href="#section6" className="hover:text-pallete-500">6. Ιστορικό</a>
            <a href="#section7" className="hover:text-pallete-500">7. Συμφωνία</a>
            <a href="#section8" className="hover:text-pallete-500">8. Πληρωμές</a>
            <a href="#section9" className="hover:text-pallete-500">9. Αποσύνδεση</a>
            <a href="#section10" className="hover:text-pallete-500">10. Υποστήριξη Πελατών</a>
            <a href="#section11" className="hover:text-pallete-500">11. Πληροφορίες Ασφάλειας</a>
            <a href="#section12" className="hover:text-pallete-500">12. Ειδοποιήσεις</a>
            <a href="#section13" className="hover:text-pallete-500">13. Κριτικές και Βαθμολογίες</a>
            <a href="#section14" className="hover:text-pallete-500">14. Δυνατότητες για Επαγγελματίες</a>
            <a href="#section15" className="hover:text-pallete-500">15. Δυνατότητες για Γονείς</a>
          </div>
          ...
          <div id="section5" className='px-20 mt-10 mb-10'>
              <p className='font-semibold text-xl mb-2'>5. Αλλαγή Στοιχείων Λογαριασμού</p>
          ...
          <div id="section6" className='px-20 mt-10'>
              <p className='font-semibold text-xl mb-2'>6. Ιστορικό</p>
          ...
          <div id="section7" className='px-20 mt-10'>
              <p className='font-semibold text-xl mb-2'>7. Συμφωνία</p>
          ...
          <div id="section8" className='px-20 mt-10'>
              <p className='font-semibold text-xl mb-2'>8. Πληρωμές</p>
          ...
          <div id="section9" className='px-20 mt-10 mb-10'>
              <p className='font-semibold text-xl mb-2'>9. Αποσύνδεση</p>
          ...
          <div id="section10" className='px-20 mt-10 mb-10'>
              <p className='font-semibold text-xl mb-2'>10. Υποστήριξη Πελατών</p>
          ...
          <div id="section11" className='px-20 mt-10 mb-10'>
              <p className='font-semibold text-xl mb-2'>11. Πληροφορίες Ασφάλειας</p>
          ...
          <div id="section12" className='px-20 mt-10 mb-10'>
              <p className='font-semibold text-xl mb-2'>12. Ειδοποιήσεις</p>
          ...
          <div id="section13" className='px-20 mt-10 mb-10'>
              <p className='font-semibold text-xl mb-2'>13. Κριτικές και Αξιολογήσεις</p>
          ...
          <div id="section14" className='px-20 mt-10 mb-10'>
            <p className='font-semibold text-xl mb-2'>14. Δυνατότητες για Επαγγελματίες</p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
          ...
          <div id="section15" className='px-20 mt-10 mb-10'>
            <p className='font-semibold text-xl mb-2'>15. Δυνατότητες για Γονείς</p>
            <ul className="list-disc pl-5 space-y-2">
              <li>

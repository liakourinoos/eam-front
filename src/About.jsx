...
function App() {
  ...
  if(!loading )
    return (
      ...
      <a href="#section2" className="hover:text-pallete-500">2. Δημιουργία Λογαριασμού/ Είσοδος στην υπηρεσία</a>
      <a href="#section3" className="hover:text-pallete-500">3. Προφίλ Γονέα</a>
      <a href="#section4" className="hover:text-pallete-500">4. Προφίλ Επαγγελματία</a>
      <a href="#section5" className="hover:text-pallete-500">5. Ιστορικό</a>
      <a href="#section6" className="hover:text-pallete-500">6. Συμφωνία</a>
      <a href="#section7" className="hover:text-pallete-500">7. Πληρωμές</a>
      <a href="#section8" className="hover:text-pallete-500">8. Αποσύνδεση</a>
  ...
  <div id="section5" className='px-20 mt-10'>
  ...
  <div id="section8" className='px-20 mt-10 mb-10'>

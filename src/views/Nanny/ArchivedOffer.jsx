    ...
    return(
        ...
        <div className='w-full h-20 text-2xl rounded-md border-2 text-center border-gray-300 bg-white flex items-center font-medium  py-2'>
            ...
            <div className='w-1/3 flex justify-center px-2 gap-2 '>
                <Link to={`/viewoffer/${code}`} className='w-2/3  h-14 rounded-md border-2 border-pallete-800 text-pallete-800 hover:text-white hover:bg-pallete-800 flex gap-2 items-center justify-center px-2'>
